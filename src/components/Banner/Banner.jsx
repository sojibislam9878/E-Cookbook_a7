      ...
      >
        <div className="t text-center text-white">
          <div className=" lg:w-2/3 lg:mx-auto lg:pt-44 pt-10">
            ...
            <button className="btn bg-[#0BE58A] border-[#0BE58A] rounded-full lg:mt-10 lg:mb-44 mt-6">
              Explore Now
            </button>
            <button className="btn btn-outline rounded-full mx-6 mb-6 mt-6 text-white hover:bg-[#0BE58A] hover:border-[#0BE58A]">
              Our Feedback
            </button>
          </div>
        </div>
